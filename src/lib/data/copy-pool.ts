...
export const SHARE_CARD_PHRASES =
	copyPoolData.shareCardPhrases as typeof copyPoolData.shareCardPhrases;
export const SHARE_CARD_CAPTIONS =
	copyPoolData.shareCardCaptions as typeof copyPoolData.shareCardCaptions;
export const FRICTION_PATTERNS =
	copyPoolData.frictionPatterns as typeof copyPoolData.frictionPatterns;

/** ── Seasons (사랑의 계절) 템플릿 ── */
export const stepThemes = (copyPoolData as any).themes;

export const SEASON_FIRST_MEET =
	copyPoolData.seasonFirstMeet as typeof copyPoolData.seasonFirstMeet;
...
export const MISREADING_PATTERNS =
	copyPoolData.misreadingPatterns as typeof copyPoolData.misreadingPatterns;
